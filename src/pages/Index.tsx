        ...
        <div className="container max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="price-card">
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-navy-800 mb-2">Free Trial</h3>
                <p className="text-navy-600">Perfect for getting started</p>
              </div>
              
              <div className="mb-6">
                <span className="text-4xl font-bold text-navy-800">$0</span>
              </div>
            ...
            <div className="price-card price-card-popular">
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-navy-800 mb-2">Professional</h3>
                <p className="text-navy-600">For growing teams</p>
              </div>
            ...
            <div className="price-card">
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-navy-800 mb-2">Enterprise</h3>
                <p className="text-navy-600">For large organizations</p>
              </div>
              
              <div className="mb-6">
                <span className="text-4xl font-bold text-navy-800">Custom</span>
              </div>
